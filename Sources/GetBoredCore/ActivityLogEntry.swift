...
public struct ActivityLogEntry: Identifiable, Codable {
    ...
    public init(displayDomain: String,
                blocked: Bool,
                reason: String,
    ...
    public init(domain: String, blocked: Bool, reason: String, sourceApp: String? = nil, timestamp: Date = Date()) {
        self.init(
    ...
    public var domain: String { displayDomain }

    /// "BLOCKED" or "ALLOWED" for display
    public var verdictText: String { blocked ? "BLOCKED" : "ALLOWED" }
